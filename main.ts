...
function generar_mensaje_fahrenheit (fahrenheit2: number) {
    return "Conversión a grados Fahrenheit:" + ("" + fahrenheit2) + " °F"
}
...
function juego (personatge2: Sprite, cofreGradosCelsius2: Sprite, cofreGradosFarenheit2: Sprite) {
    controller.moveSprite(personatge2)
...
if (controller.A.isPressed()) {
            grados_fahrenheit = game.askForNumber("Digues Graus Fahrenheit")
            ...
            textConveritdo.setText("" + celsius2 + "°C")
        }
    }
}
...
let fahrenheit3: number;
let mensaje2: any;
if (personatge.overlapsWith(cofreGradosFarenheit)) {
        game.ask("Presiona A para °F")
if (controller.A.isPressed()) {
            grados_celsius = game.askForNumber("Digues Graus Celsius")
            fahrenheit3 = convertir_celsius_a_fahrenheit(grados_celsius)
            mensaje2 = generar_mensaje_fahrenheit(fahrenheit3)
            game.showLongText(mensaje2, DialogLayout.Center)
            textConveritdo.setText("" + fahrenheit3 + "°F")
        }
    }
}
function convertir_celsius_a_fahrenheit (celsius3: number) {
    fahrenheit32 = celsius3 * 9 / 5 + 32
    fahrenheit_redondeado = Math.floor(fahrenheit32 * 100) / 100
    // Convierte grados Celsius a Fahrenheit
    return fahrenheit_redondeado
}
function convertir_fahrenheit_a_celsius (fahrenheit: number) {
...
function generar_mensaje_celsius (celsius4: number) {
    return "Conversión a grados Celsius: " + ("" + celsius4) + " °C"
}
let celsius_redondeado = 0
let celsiusConversor = 0
let fahrenheit_redondeado = 0
let fahrenheit32 = 0
let personatge: Sprite = null
let cofreGradosFarenheit: Sprite = null
let cofreGradosCelsius: Sprite = null
let textConveritdo: TextSprite = null
let fahrenheit2 = 0
let fahrenheit_redondeado2 = 0
...
scene.setBackgroundImage(img`
    ...
    4444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444
    `)
cofreGradosCelsius = sprites.create(assets.image`myImage`, SpriteKind.Enemy)
cofreGradosFarenheit = sprites.create(assets.image`myImage0`, SpriteKind.Enemy)
